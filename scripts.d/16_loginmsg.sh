...
reset="\033[0m"
{
  ...
  echo -e "#${red}         For more information, please visit: http://treehouses.io/             ${red}#"
  echo -e "#${red}            To begin using treehouses type 'treehouses help'                   ${red}#"
  echo -e "#${red}   Please feel free to contact us in the 'https://gitter.im/treehouses/Lobby'  ${red}#"
  echo -e "${red}#################################################################################${reset}"
